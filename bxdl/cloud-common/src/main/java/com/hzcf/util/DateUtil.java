...
public class DateUtil {
	...
	public static final String TIME_FORMAT_MONTHS = "yyyy-MM";
	...
	* @throws
	...
	public static String addDayBySomeDay(Date date,int size){
		try{
			if(StringUtil.isNotBlanks(date) && StringUtil.isNotBlanks(size)){
				SimpleDateFormat format=new SimpleDateFormat("yyyy-MM-dd");
				Calendar calendar = Calendar.getInstance();
				calendar.setTime(date);
				calendar.add(Calendar.DAY_OF_MONTH, +size);//+1今天的时间加一天

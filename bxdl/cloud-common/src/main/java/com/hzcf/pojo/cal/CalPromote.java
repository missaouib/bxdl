 ...
 * 展业津贴参数
 */
public class CalPromote implements Serializable {
	private static final long serialVersionUID = 56570196643493323L;
	/** 主键 */
	private Long id;
	/** 销售机构id */
	private Long orgId;
	...
	/** 规则（0：固定值；1：步长；2：FYC百位取整；3：FYC百分比） */

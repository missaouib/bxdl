 ...
 * 增员津贴参数表
 */
public class CalHisIncreaseStaff implements Serializable {
	private static final long serialVersionUID = -304885106990403455L;
	/** 主键 */
	private Long id;
	/** 销售机构id */
	private Long orgId;
    ...
    public boolean equals(Object o) {
        ...
        CalHisIncreaseStaff that = (CalHisIncreaseStaff) o;

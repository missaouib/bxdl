 ...
 * 部长育成奖金历史参数表
 */
public class CalHisNurtureMinister implements Serializable {
	private static final long serialVersionUID = -3285728467323484048L;
	/** 主键 */
	private Long id;
	/** 机构id */
    ...
    public boolean equals(Object o) {
        ...
        CalHisNurtureMinister that = (CalHisNurtureMinister) o;

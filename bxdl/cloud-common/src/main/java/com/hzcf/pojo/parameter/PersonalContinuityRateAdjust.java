...
public class PersonalContinuityRateAdjust implements Serializable{
    /**
	 */
    ...
    public String getContinuityRate() {
        return continuityRate;
    }

    public void setContinuityRate(String continuityRate) {
        this.continuityRate = continuityRate == null ? null : continuityRate.trim();
    }

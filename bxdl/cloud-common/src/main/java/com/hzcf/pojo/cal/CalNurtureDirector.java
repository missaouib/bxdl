 ...
 * 处长育成奖金参数表
 */
public class CalNurtureDirector implements Serializable {
	private static final long serialVersionUID = 1117020011793026073L;
	/** 主键 */
	private Long id;
	/** 机构id */
	private Long orgId;
    ...
    public boolean equals(Object o) {
        ...
        CalNurtureDirector that = (CalNurtureDirector) o;

 ...
 * 直属部管理津贴参数表
 */
public class CalDirectlyUnderDept implements Serializable {
	private static final long serialVersionUID = 6570593883027044942L;
	/** 主键 */
	private Long id;
	/** 销售机构id */
	private Long orgId;
	...
	public boolean equals(Object o) {
		...
		CalDirectlyUnderDept that = (CalDirectlyUnderDept) o;

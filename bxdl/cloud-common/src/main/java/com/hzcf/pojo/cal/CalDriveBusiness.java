 ...
 * 业务推动（针对广州）参数表
 */
public class CalDriveBusiness implements Serializable {
	private static final long serialVersionUID = -8780253663298307624L;
	/** 主键 */
	private Long id;
	/** 销售机构id */
	private Long orgId;
    ...
    public boolean equals(Object o) {
        ...
        CalDriveBusiness that = (CalDriveBusiness) o;

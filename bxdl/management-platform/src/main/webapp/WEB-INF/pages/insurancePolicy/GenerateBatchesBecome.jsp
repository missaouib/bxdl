...
<head>
    ...
    <script type="text/javascript">
        ...
        function genCommit() {
            ...
            var gen_org =  $("#gen_org").val();
            var gen_type =  $("#gen_type").val();
            var grant_forTdVal1_son =  $("#grant_forTdVal1_son_become").val();
            if (!gen_name){
                alert("转移批次名称不能为空")
                return;
            }
            ...
            $.ajax({
                url:"/insurance_policy/commit_batch_become",
                data:data,
                type:"post",
                dataType:"json",
                success: function (obj) {
                    if (obj.returnCode=="200"){
                        alert("生成批次成功")
                        commCloseTab("insurancePolicyGrantBecome:commit")
                        createAddProcessTab("becomeInsurancePolicyGrant:list","")
                    } else {
                        alert("生成批次失败")
                    }
                },
            ...
            return{
                init:function (){
                    $('#grant_already_table_son').bootstrapTable({
                        ...
                        toolbar:"#grantbb_toolbar",
                        showColumns : false, //显示隐藏列
                        uniqueId: "INSURED_PERSON_ID", //每一行的唯一标识，一般为主键列
                        queryParamsType:'',
                        queryParams: genBecome.queryParams,//传递参数（*）
                        columns : [{
                            checkbox: true
                        },{
                            field: 'SerialNumber',
                        ...
                        onLoadSuccess:function(data){
                            ...
                            $("#grant_forTdVal1_son_become").val(selectListIds)
                        },
    ...
    <div class="container" style="width: 2000px">
        ...
        <div style="overflow:scroll;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3 ">
                    <input type="text" class="form-control form-control-static" id="gen_type"
                           name="gen_type">
                </div>
                ...
                <div class="col-md-3 ">
                    <input type="date" class="form-control form-control-static" id="gen_date"
                           name="gen_date">
                    <input type="hidden" name="grant_forTdVal1_son" id="grant_forTdVal1_son_become">
                </div>
            </div>
        </div>

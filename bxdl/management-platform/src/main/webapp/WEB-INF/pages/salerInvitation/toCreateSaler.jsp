...
<head>
 <title>新增销售人员	</title>
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <script src="${path}/js/insurance/toCreateSaler.js"></script>
</head>
<body>
            <div class="container">
			...
			<div class="form-group">
				...
				<div class="col-md-3 ">
					<select class="form-control form-control-static" id="salesOrgId" name="salesOrgId">
			...
			<div class="form-group">
				...
				<div class="col-md-3 ">
					<input type="text" id="parentSalesTeamName"  name="parentSalesTeamName" class="form-control form-control-static" placeholder="请输入销售团队名称">
				</div>

				<label class="col-md-2 control-label">销售团队代码：</label>
				<input type="hidden" id="PTcode" name="PTcode" value="" />
				<div class="col-md-3 ">
					<select class="form-control form-control-static" id="salesTeamId" name="salesTeamId">
			...
			<div class="form-group">
				...
				<div class="col-md-3 ">
             	...
             	<input type="hidden" id="rz_invitedId" name="invitedId" value="${salerInvitation.invitedId}" />	
				<label class="col-md-2 control-label">员工姓名：</label>
				<div class="col-md-3 ">
					<input type="text" id="insuranceSaler"  name="insuranceSaler" value="${salerInvitation.personName}" class="form-control form-control-static" placeholder="请输入员工姓名">
				</div>             	
			</div>	
			...
			<div class="form-group">
				...
				<div class="col-md-3 ">
					<input type="text" id="mobile"  name="mobile" value="${salerInvitation.personMobile}" class="form-control form-control-static" placeholder="请输入手机号码">
				</div>

				<label class="col-md-2 control-label">入司时间：</label>
				<div class="col-md-3 ">
                   <input class="form-control form-control-static" id="joinDate" name="joinDate" value="2019-01-01" type="text" placeholder="请选择入司时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-3 ">
                   <input class="form-control form-control-static" id="birthday" name="birthday" value="2019-01-01" type="text" placeholder="请选择出生时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
             	</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-3 ">
					<input type="text" id="bankCardNo"  name="bankCardNo" class="form-control form-control-static" placeholder="请输入证件号码">			
             	</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-3 ">
                   <input class="form-control form-control-static" id="marriageDate" name="marriageDate" value="2019-01-01" type="text" placeholder="请选择结婚时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
             	</div>
			</div>
          	...
          	<div class="form-group">    	
				...
				<div class="col-md-3 ">
					<input type="text" id="preCompany"  name="preCompany" class="form-control form-control-static" placeholder="请输入外语水平">
				</div>	
				
 				<label class="col-md-2 control-label">上家公司职业：</label>
				<div class="col-md-3 ">
					<input type="text" id="preOccupation"  name="preOccupation" class="form-control form-control-static" placeholder="请输入外语水平">
				</div>					            	
             </div>				
			...
			<div class="form-group">
				...
				<div class="col-md-3 ">
                   <input class="form-control form-control-static" id="certificateStartDate" name="certificateStartDate" value="2019-01-01" type="text" placeholder="请选择执业证有效期起" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
             	</div>			
			
				<label class="col-md-2 control-label">执业证有效期止：</label>
				<div class="col-md-3 ">
                   <input class="form-control form-control-static" id="certificateEndDate" name="certificateEndDate" value="2019-01-01" type="text" placeholder="请选择执业证有效期止" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
             	</div>
			</div>	
			...
			<div class="form-group">
				...
				<div class="col-md-3 " style="width:880px;">
					<div style="overflow:auto;width:850px;">
					<table id="guanxi_list" class="table table-hover table-striped table-condensed table-bordered" style="width:850px;font-size:13px;">
						<tr>
							<td style="width:100px;text-align:center;">关系</td>
							<td style="width:120px;text-align:center;">销售人员</td>
							<td style="width:150px;text-align:center;">销售人员代码</td>
							<td style="width:200px;text-align:center;">组织机构</td>
							<td style="width:150px;text-align:center;">营销团队</td>
							<td style="width:130px;text-align:center;">确立日期</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:center;">担保人</td>
							<td style="width:120px;text-align:center;">
							<div class="col-md-3 " style="width:120px;">
								<select class="form-control form-control-static" id="dbSalesId" name="dbSalesId">
									<option value="">请选择</option>
			             		</select>				
			             	</div>							
							</td>
							...
							<div class="col-md-3 " style="width:150px;">
                   			<input class="form-control form-control-static" id="dbSalesNo" name="dbSalesNo" value="${salerInvitation.dbSalerNo}" type="text" placeholder="员工编号" />
							</div>							
							</td>
							...
							<div class="col-md-3 " style="width:130px;">
                   			<input class="form-control form-control-static" id="dbSalesDate" name="dbSalesDate" value="2019-01-01" type="text" placeholder="" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
							</div>							
							</td>
						</tr>
						<tr>
							...
							<td style="width:120px;text-align:center;">
							<div class="col-md-3 " style="width:120px;">
								<select class="form-control form-control-static" id="tjSalesId" name="tjSalesId">
									<option value="">请选择</option>
			             		</select>				
			             	</div>							
							</td>
							<td style="width:150px;text-align:center;">
							<div class="col-md-3 " style="width:150px;">
                   			<input class="form-control form-control-static" id="tjSalesNo" name="tjSalesNo" value="${salerInvitation.tjSalerNo}" type="text" placeholder="员工编号" />
							</div>							
							</td>
							<td style="width:200px;text-align:center;"></td>
							...
							<td style="width:130px;text-align:center;">
							<div class="col-md-3 " style="width:130px;">
                   			<input class="form-control form-control-static" id="tjSalesDate" name="tjSalesDate" value="2019-01-01" type="text" placeholder="" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
							</div>							
							</td>
						</tr>
						<tr>
							<td style="width:100px;text-align:center;">育成人</td>
							<td style="width:120px;text-align:center;">
							<div class="col-md-3 " style="width:120px;">
								<select class="form-control form-control-static" id="ycSalesId" name="ycSalesId">
									<option value="">请选择</option>
			             		</select>				
			             	</div>								
							</td>
							<td style="width:150px;text-align:center;">
							<div class="col-md-3 " style="width:150px;">
                   			<input class="form-control form-control-static" id="ycSalesNo" name="ycSalesNo" value="" type="text" placeholder="员工编号" />
							</div>								
							</td>
							<td style="width:200px;text-align:center;"></td>
							<td style="width:120px;text-align:center;"></td>
							<td style="width:130px;text-align:center;">
							<div class="col-md-3 " style="width:130px;">
                   			<input class="form-control form-control-static" id="ycSalesDate" name="ycSalesDate" value="2019-01-01" type="text" placeholder="" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
							</div>							
							</td>
						</tr>
						<tr>
							...
							<td style="width:120px;text-align:center;">
							<div class="col-md-3 " style="width:120px;">
								<select class="form-control form-control-static" id="sjSalesId" name="sjSalesId">
									<option value="">请选择</option>
			             		</select>				
			             	</div>								
							</td>
							<td style="width:150px;text-align:center;">
							<div class="col-md-3 " style="width:150px;">
                   			<input class="form-control form-control-static" id="sjSalesNo" name="sjSalesNo" value="" type="text" placeholder="员工编号" />
							</div>								
							</td>
							<td style="width:200px;text-align:center;"></td>
							<td style="width:120px;text-align:center;"></td>
							<td style="width:130px;text-align:center;">
							<div class="col-md-3 " style="width:130px;">
                   			<input class="form-control form-control-static" id="sjSalesDate" name="sjSalesDate" value="2019-01-01" type="text" placeholder="" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
							</div>							
							</td>
						</tr>
						<tr>
							...
							<td style="width:120px;text-align:center;">
							<div class="col-md-3 " style="width:120px;">
								<select class="form-control form-control-static" id="jcSalesId" name="jcSalesId">
									<option value="">请选择</option>
			             		</select>				
			             	</div>								
							</td>
							<td style="width:150px;text-align:center;">
							<div class="col-md-3 " style="width:150px;">
                   			<input class="form-control form-control-static" id="jcSalesNo" name="jcSalesNo" value="" type="text" placeholder="员工编号" />
							</div>								
							</td>
							<td style="width:200px;text-align:center;"></td>
							<td style="width:120px;text-align:center;"></td>
							<td style="width:130px;text-align:center;">
							<div class="col-md-3 " style="width:130px;">
                   			<input class="form-control form-control-static" id="jcSalesDate" name="jcSalesDate" value="2019-01-01" type="text" placeholder="" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
							</div>							
							</td>
						</tr>
						<tr>
							...
							<td style="width:120px;text-align:center;">
							<div class="col-md-3 " style="width:120px;">
								<select class="form-control form-control-static" id="fdSalesId" name="fdSalesId">
									<option value="">请选择</option>
			             		</select>				
			             	</div>								
							</td>
							<td style="width:150px;text-align:center;">
							<div class="col-md-3 " style="width:150px;">
                   			<input class="form-control form-control-static" id="fdSalesNo" name="fdSalesNo" value="" type="text" placeholder="员工编号" />
							</div>								
							</td>
							<td style="width:200px;text-align:center;"></td>
							<td style="width:120px;text-align:center;"></td>
							<td style="width:130px;text-align:center;">
							<div class="col-md-3 " style="width:130px;">
                   			<input class="form-control form-control-static" id="fdSalesDate" name="fdSalesDate" value="2019-01-01" type="text" placeholder="" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
							</div>							
							</td>
						</tr>																																				
					</table>
...
<div id="zcAddDlg" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="zcadd_myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="col-md-3">
            <input class="form-control form-control-static" id="zc_gotDate" name="zc_gotDate" value="2019-01-01" type="text" placeholder="请选择获得时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
			...
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="zc_effectiveDate" name="zc_effectiveDate" value="2019-01-01" type="text" placeholder="请选择生效时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>	
			...
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="zc_invalidDate" name="zc_invalidDate" value="2019-01-01" type="text" placeholder="请选择失效时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>						
			...
			<label class="col-md-2 control-label">备注：</label>
			<div class="col-md-3 ">
			<input type="text" id="zc_remark" name="zc_remark" class="form-control form-control-static" placeholder="请输入职级名称">
			</div>
			</div>
            <div class="modal-footer col-md-6">
            <!--用来清空表单数据-->
...
<div id="zcMydlg" class="modal fade"  tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="zcup_myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<label class="col-md-2 control-label">获取日期：</label>
			<div class="col-md-3">
            <input class="form-control form-control-static" id="zc_update_gotDate" name="zc_update_gotDate" value="2019-01-01" type="text" placeholder="请选择获得时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
			...
			<label class="col-md-2 control-label">生效日期：</label>
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="zc_update_effectiveDate" name="zc_effectiveDate" value="2019-01-01" type="text" placeholder="请选择生效时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>	
			...
			<label class="col-md-2 control-label">失效日期：</label>
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="zc_update_invalidDate" name="zc_update_invalidDate" value="2019-01-01" type="text" placeholder="请选择失效时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>						
...
<div id="zhengshuAddDlg" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="zsadd_myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="col-md-3">
            <input class="form-control form-control-static" id="zs_gotDate" name="zs_gotDate" value="2019-01-01" type="text" placeholder="请选择发证时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
			...
			<label class="col-md-2 control-label">失效日期：</label>
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="zs_invalidDate" name="zs_invalidDate" value="2019-01-01" type="text" placeholder="请选择失效时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>						
...
<div id="zhengshuMydlg" class="modal fade"  tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="zsup_myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<label class="col-md-2 control-label">发证日期：</label>
			<div class="col-md-3">
            <input class="form-control form-control-static" id="zs_update_gotDate" name="zs_update_gotDate" value="2019-01-01" type="text" placeholder="请选择获得时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
			...
			<label class="col-md-2 control-label">失效日期：</label>
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="zs_update_invalidDate" name="zs_update_invalidDate" value="2019-01-01" type="text" placeholder="请选择失效时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>						
...
<div id="jyjlAddDlg" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="col-md-3">
            <input class="form-control form-control-static" id="jyjl_startDate" name="jyjl_startDate" value="2019-01-01" type="text" placeholder="请选择开始日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
			...
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="jyjl_endDate" name="jyjl_endDate" value="2019-01-01" type="text" placeholder="请选择结束时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
...
<div id="jyjlMydlg" class="modal fade"  tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<label class="col-md-2 control-label">开始日期：</label>
			<div class="col-md-3">
            <input class="form-control form-control-static" id="jyjl_update_startDate" name="jyjl_update_startDate" value="2019-01-01" type="text" placeholder="请选择开始日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
			...
			<label class="col-md-2 control-label">结束日期：</label>
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="jyjl_update_endDate" name="jyjl_update_endDate" value="2019-01-01" type="text" placeholder="请选择结束时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
...
<div id="gzjlAddDlg" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<label class="col-md-2 control-label">开始日期：</label>
			<div class="col-md-3">
            <input class="form-control form-control-static" id="gzjl_startDate" name="gzjl_startDate" value="2019-01-01" type="text" placeholder="请选择开始日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
			...
			<label class="col-md-2 control-label">结束日期：</label>
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="gzjl_endDate" name="gzjl_endDate" value="2019-01-01" type="text" placeholder="请选择结束时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
...
<div id="gzjlMydlg" class="modal fade"  tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<label class="col-md-2 control-label">开始日期：</label>
			<div class="col-md-3">
            <input class="form-control form-control-static" id="gzjl_update_startDate" name="gzjl_update_startDate" value="2019-01-01" type="text" placeholder="请选择开始日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
			...
			<label class="col-md-2 control-label">结束日期：</label>
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="gzjl_update_endDate" name="gzjl_update_endDate" value="2019-01-01" type="text" placeholder="请选择结束时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
...
<div id="pxjlAddDlg" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<label class="col-md-2 control-label">开始日期：</label>
			<div class="col-md-3">
            <input class="form-control form-control-static" id="pxjl_startDate" name="pxjl_startDate" value="2019-01-01" type="text" placeholder="请选择开始日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
			...
			<label class="col-md-2 control-label">结束日期：</label>
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="pxjl_endDate" name="pxjl_endDate" value="2019-01-01" type="text" placeholder="请选择结束时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
...
<div id="pxjlMydlg" class="modal fade"  tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<label class="col-md-2 control-label">开始日期：</label>
			<div class="col-md-3">
            <input class="form-control form-control-static" id="pxjl_update_startDate" name="pxjl_update_startDate" value="2019-01-01" type="text" placeholder="请选择开始日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
			...
			<label class="col-md-2 control-label">结束日期：</label>
			<div class="col-md-3 ">
            <input class="form-control form-control-static" id="pxjl_update_endDate" name="pxjl_update_endDate" value="2019-01-01" type="text" placeholder="请选择结束时间" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})"/>
			</div>
			</div>
...
<div id="swdbrAddDlg" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="col-md-3 ">
			<input type="text" id="swdbr_guaranteeDate"  name="swdbr_guaranteeDate" value="2019-01-01" class="form-control form-control-static" placeholder="请输入担保日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" >
			</div>
			</div>						
            <div class="modal-footer col-md-6">
            <!--用来清空表单数据-->
...
<div id="htAddDlg" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="col-md-3 ">
			<input type="text" id="ht_writeDate"  name="ht_writeDate" value="2019-01-01" class="form-control form-control-static" placeholder="请输入签订日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" />
			</div>
			</div>
			...
			<div class="col-md-3 ">
			<input type="text" id="ht_probationEnd"  name="ht_probationEnd" value="2019-01-01" class="form-control form-control-static" placeholder="请输入试用结束日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" />
			</div>
			</div>
			...
			<div class="col-md-3 ">
			<input type="text" id="ht_contractEffectDate"  name="ht_contractEffectDate" value="2019-01-01" class="form-control form-control-static" placeholder="请输入合同生效日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" />
			</div>
			</div>
			...
			<div class="col-md-3 ">
			<input type="text" id="ht_contractStopDate"  name="ht_contractStopDate" value="2019-01-01" class="form-control form-control-static" placeholder="请输入合同失效日期" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',readOnly:true})" />
			</div>
			</div>														
            <div class="modal-footer col-md-6">
            <!--用来清空表单数据-->

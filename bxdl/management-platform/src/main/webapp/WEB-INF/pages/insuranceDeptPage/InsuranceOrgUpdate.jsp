			                    ...
			                    success:function(data){
			                        if(data){
										...
										$.alert({
			                 		    ...
			                 		    document.getElementById("saveButton").removeAttribute("disabled");
										commCloseTab('insCompanyOrg:update');
...
<body>
			...
			<div class="form-group">
				...
				<div class="col-md-3 ">
					<input type="text" id="insuranceCompanyName"  name="insuranceCompanyName" value="${insurancedept.insuranceCompanyName}" class="form-control form-control-static" placeholder="请输入组织机构名称">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-2 control-label">组织机构级别*：</label>
				<div class="col-md-3 ">
					<select class="form-control form-control-static" id="orgLevel" name="orgLevel">
...
<%--                        <option value="01" <c:if test="${insurancedept.orgLevel=='01'}"> selected="selected"</c:if> >>总公司</option>--%>
			...
			<div class="form-group">
				...
				<div class="col-md-3 ">
					<input type="text" id="insuranceCompanyCode"  name="insuranceCompanyCode"  value="${insurancedept.insuranceCompanyCode}" class="form-control form-control-static" placeholder="请输入组织机构代码"onkeyup="number()" />
					<span style="display:none;" id="showCheap">格式错误</span>
				</div>
			
				<label class="col-md-2 control-label">组织机构简称：</label>
				<div class="col-md-3 ">
					<input type="text" id="insuranceCompanyNameLess"  name="insuranceCompanyNameLess" value="${insurancedept.insuranceCompanyNameLess}" class="form-control form-control-static" placeholder="请输入组织机构简称">				
             	</div>
			</div>
			<div class="form-group">
				<label class="col-md-2 control-label">组织机构英文名：</label>
               <div class="col-md-3">
                   <input class="form-control form-control-static" id="insuranceCompanyEnName" value="${insurancedept.insuranceCompanyEnName}" name="insuranceCompanyEnName" type="text" placeholder="请选择英文名" />
               </div>

				<label class="col-md-2 control-label">组织机构英文简称：</label>
				<div class="col-md-3 ">
					<input type="text" id="insuranceCompanyEnNameLess"  name="insuranceCompanyEnNameLess" value="${insurancedept.insuranceCompanyEnNameLess}" class="form-control form-control-static" placeholder="请输入英文简称">
				</div>
			</div>	
			<div class="form-group">

...
<head>
 <title>继续率奖金-新增例外产品	</title>
   <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <script src="${path}/js/insurance/pbExitProAdd.js"></script>
    <style type="text/css">
		table td{
		     overflow: hidden;
...
<form class="form-horizontal" id="Pb_ExitPro_addForm"  method="post">
	...
	<input type="hidden" id="monthyBasic" name="monthyBasic" value="" /><!--结算继续率奖金参数-->
	...
	<input type="hidden" id="thrMonthyBasic" name="thrMonthyBasic" value="" /><!--季度算继续率奖金参数-->
	...
	<input type="hidden" id="sixMonthyBasic" name="sixMonthyBasic" value="" /><!--半年算继续率奖金参数-->
	...
	<input type="hidden" id="twnMonthyBasic" name="twnMonthyBasic" value="" /><!--年通算继续率奖金参数-->

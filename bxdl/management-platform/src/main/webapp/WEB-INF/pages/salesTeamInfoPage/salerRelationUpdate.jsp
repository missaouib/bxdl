			   ...
			   updater: function (item) {
				   ...
				   var cal_org_id = $("#insuranceSalesId").attr("cal_org_id");
				    ...
				    if(id == "sjSales"){
				        debugger;
				        var sjFlag = true;
				         var SalesLevel =$("#insuranceSalesId").attr("gradeId");
			 ...
			 items:8,
			   ...
			   updater: function (item) {
                   ...
                   if(id == "ycCFirstGenerNo" || id == "ycCSecondGenerNo"){
				    ...
				    $("#"+id).parent("td").prev("input").prev().find("input").val(item.INSURANCE_SALER);
...
<div style="width: 99%;overflow: auto;">
	 ...
	 <div class="modal-footer col-md-6">
            <!--用来清空表单数据-->
		  <button id="effective_now" type="button" onclick="add(1)" class="btn btn-primary">立即生效</button>
            </div>
	  </form>
</div>
<!--toolbar  -->
